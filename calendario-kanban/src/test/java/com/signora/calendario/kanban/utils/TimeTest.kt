...
class TimeTest {
    ...
    fun `when getOffsetSize is called, should return offset size`() {
        val (offset, size) = getOffsetSize(
            range = LocalDateTime.of(2023, 1, 1, 0, 0, 0) to LocalDateTime.of(2023, 1, 1, 23, 59, 59),
    ...
    fun `when getOffsetSize with week period is called, should return offset size`() {
        val (offset, size) = getOffsetSize(
            range = LocalDateTime.of(2023, 1, 2, 0, 0, 0) to LocalDateTime.of(2023, 1, 8, 23, 59, 59),
